...
- **Rust Token Killer** (`dragonGR/rtk`) — this project, a token-saving CLI proxy
...
```bash
curl -fsSL https://raw.githubusercontent.com/dragonGR/rtk/master/install.sh | sh
```

## Homebrew (macOS and Linux)

```bash
brew install dragonGR/tap/rtk
```
...
```bash
cargo install --git https://github.com/dragonGR/rtk --branch master rtk
```
